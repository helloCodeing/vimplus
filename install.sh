...
{
    brew install vim gcc cmake ctags-exuberant curl ack ag
}
...
{
    sudo apt-get install -y ctags build-essential cmake python-dev python3-dev fontconfig curl libfile-next-perl ack-grep silversearcher-ag python3-sdl2 python-sdl2 figlet lolcat hollywood cmatrix
    ...
    if [ ${ubuntu_1604} == 1 ]; then
        ...
        echo "not ubuntu 16.04 LTS apt install vim"
